...
//    Extends: APE.Client,
    ...
    options: {
        ...
        irc_server: 'irc.thehelper.net',
        irc_port: 6667,
        original_channels:['#thehelper'],
        systemChannel: '@thehelper',
        systemUser: '*System*',
        helpUser: '*HELP*'
    },
    root: null,
    ...
    initPlayground: function(){
        ...
        this.els.chatZone = this.root.getElement('.history');
        this.els.tabs = this.root.getElement('.tabs');
        this.els.input = this.root.getElement('.input');;
        this.els.userList = this.root.getElement('.user-list');
        this.els.userCnt = this.root.getElement('.user-count');

        this.root.getElement('.input-zone button').addEvent('click', this.sendClick.bindWithEvent(this));
